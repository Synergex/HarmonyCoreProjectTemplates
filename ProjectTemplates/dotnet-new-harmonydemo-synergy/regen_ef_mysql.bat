...
rem ===================================================================================================================================================
rem 
rem Title:	regen_ef_mysql.bat
rem 
rem This is an example of how to generate the required Entity Framework (EF) code if you are building a Harmony Core data service on top of a third
rem party relational database. The example code in this file is for MySQL 8, using a third-party EF provider called "Pomelo" (more details below).
rem 
rem ===================================================================================================================================================
...
rem
rem    Edit the generated "DB context" class (see DBCONTEXT_CLASS below) and:
...
set MYSQL_SERVER=siubuntu2004
set MYSQL_DATABASE=MyDatabase
set MYSQL_USERNAME=root
set MYSQL_PASSWORD=p@ssw0rd
set MYSQL_TABLES=-t TABLE1 -t TABLE2 -t TABLE3 -t TABLE4 -t TABLE5
...
set DBCONTEXT_CLASS=MyDbContext

rem Generate the EF code
