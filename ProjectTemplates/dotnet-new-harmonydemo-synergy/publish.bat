...
set BridgeFolder=TraditionalBridge
set BridgeDbrFile=%SolutionDir%TraditionalBridge\bin\Debug\x64\TraditionalBridgeHost.dbr
set BridgeBatchFile=%SolutionDir%TraditionalBridge\bin\Debug\x64\launch.bat
